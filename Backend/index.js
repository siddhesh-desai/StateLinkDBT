...
app.get('/student/login', authController.login_get);
app.get('/student/signup', authController.signup_get);
app.get('/student/logout', authController.logout_get);

app.post('/student/login', authController.login_post);
app.post('/student/signup', authController.signup_post);
